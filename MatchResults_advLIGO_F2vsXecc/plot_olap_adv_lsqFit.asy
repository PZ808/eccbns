...
file in1 = line(input("Match_advanced_1.4_1.4_3_4_3.5PN.txt"));
...
file in2=line(input("Match_advanced_1.4_5.0_3_4_3.5PN.txt"));
...
file in3 = line(input("Match_advanced_5.0_5.0_3_4_3.5PN.txt"));
...
attach(legend(), NE, -220E +20N, UnFill);
