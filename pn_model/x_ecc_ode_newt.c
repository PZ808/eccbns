/* $Id: x_ecc_ode_newt.c,v 1.1 2009/05/31 15:03:48 pzimmerman Exp $ */
...
{ 
  ...
  double u = pn_kepler_equation( conservative_pn_order, eta, x, e, l );

  /* The zero eccentricitiy case requires special treatment 
   * due to coordinate singularities in the conservative PN 
   * expressions 
   */
